...
void TEST_CASE1(void) {
  ...
  asm volatile("vloxei32.v v0, (%0), v8" ::"r"(&ALIGNED_I32[0]));
...
void TEST_CASE2(void) {
  VSET(16, e32, m1);
  VLOAD_32(v8, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60);
  asm volatile("vloxei32.v v1, (%0), v8" ::"r"(&ALIGNED_I32[0]));
...
void TEST_CASE3(void) {
  ...
  asm volatile("vloxei32.v v4, (%0), v2" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE4(void) {
  ...
  VLOAD_32(v8, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60);
  asm volatile("vloxei32.v v3, (%0), v8, v0.t" ::"r"(&ALIGNED_I32[0]));
...
void TEST_CASE7(void) {
  ...
  asm volatile("vloxei32.v v4, (%0), v8, v0.t" ::"r"(&ALIGNED_I32[0]));
  VSET(16, e32, m1);
...
void TEST_CASE11(void) {
  ...
  asm volatile("vloxei32.v v5, (%0), v8" ::"r"(&ALIGNED_I32[0]));
...
void TEST_CASE12(void) {
  ...
  asm volatile("vloxei32.v v4, (%0), v8" ::"r"(&ALIGNED_I8[0]));
...
void TEST_CASE13(void) {
  ...
  VLOAD_32(v8, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60);
  asm volatile("vloxei32.v v6, (%0), v8" ::"r"(&ALIGNED_I32[0]));
...
void TEST_CASE16(void) {
  ...
  VLOAD_32(v8, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60);
  write_csr(vstart, 2);
  asm volatile("vloxei32.v v7, (%0), v8" ::"r"(&ALIGNED_I32[0]));
  write_csr(vstart, 0);
...
void TEST_CASE17(void) {
  ...
  asm volatile("vloxei32.v v12, (%0), v8" ::"r"(&ALIGNED_I8[0]));
...
void TEST_CASE18(void) {
  ...
  asm volatile("vloxei32.v v12, (%0), v8" ::"r"(&ALIGNED_I16[0]));
...
void TEST_CASE19(void) {
  VSET(16, e32, m1);
  VLOAD_32(v8, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60);;
  asm volatile("vloxei32.v v9, (%0), v8" ::"r"(&ALIGNED_I32[0]));
...
void TEST_CASE20(void) {
  ...
  asm volatile("vloxei32.v v9, (%0), v8" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE21(void) {
  VSET(2, e32, m1);
  VLOAD_32(v8, 4, 60);
  asm volatile("vloxei32.v v10, (%0), v8" ::"r"(&ALIGNED_I32[0]));
...
int main(void) {
  ...
  printf("*****Running tests for vloxei32.v*****\n");
  TEST_CASE1();
  TEST_CASE2();
  TEST_CASE3();
  TEST_CASE4();
