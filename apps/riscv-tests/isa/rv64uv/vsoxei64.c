...
void TEST_CASE1(void) {
  ...
  asm volatile("vsoxei64.v v0, (%0), v8" ::"r"(&BUFFER_O64[0]));
...
void TEST_CASE2(void) {
  ...
  VLOAD_64(v1, 0x9fe419208f2e05e0, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840,
        ...
        0x8913984898951989);
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vsoxei64.v v1, (%0), v8" ::"r"(&BUFFER_O64[0]));
...
void TEST_CASE3(void) {
  ...
  asm volatile("vsoxei64.v v4, (%0), v2" ::"r"(&BUFFER_O64[0]));
...
void TEST_CASE4(void) {
  ...
  asm volatile("vsoxei64.v v3, (%0), v8, v0.t" ::"r"(&BUFFER_O64[0]));
  VCLEAR(v3);
...
void TEST_CASE5(void) {
  ...
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vsoxei64.v v3, (%0), v8" ::"r"(&BUFFER_O64[0]));
  VCLEAR(v3);
  VLOAD_64(v3, 0x9fe419208f2e05e0, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840,
        0x99991348a9f38cd1, 0x9fa831c7a11a9384, 0x3819759853987548,
        0x1893179501093489, 0x81937598aa819388, 0x1874754791888188,
...
void TEST_CASE7(void) {
  ...
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vsoxei64.v v4, (%0), v8" ::"r"(&BUFFER_O64[0]));
  VCLEAR(v4);
  VLOAD_8(v0, 0xAA, 0xAA);
  VLOAD_64(v4, 0x9fe419208f2e05e0, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840,
        0x99991348a9f38cd1, 0x9fa831c7a11a9384, 0x3819759853987548,
  ...
  asm volatile("vsoxei64.v v4, (%0), v8, v0.t" ::"r"(&BUFFER_O64[0]));
  VCLEAR(v4);
...
void TEST_CASE11(void) {
  ...
  asm volatile("vsoxei64.v v5, (%0), v8" ::"r"(&BUFFER_O8[0]));
...
void TEST_CASE12(void) {
  ...
  VLOAD_64(v6, 0x9fe419208f2e05e0, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840,
        ...
        0x8913984898951989);
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vsoxei64.v v6, (%0), v8" ::"r"(&BUFFER_O64[0]));
  VCLEAR(v6);
...
void TEST_CASE15(void) {
  ...
  asm volatile("vsoxei64.v v7, (%0), v8" ::"r"(&BUFFER_O64[0]));
  VCLEAR(v7);
...
void TEST_CASE16(void) {
  ...
  asm volatile("vsoxei64.v v16, (%0), v8" ::"r"(&BUFFER_O8[0]));
...
void TEST_CASE17(void) {
  ...
  asm volatile("vsoxei64.v v12, (%0), v8" ::"r"(&BUFFER_O16[0]));
...
void TEST_CASE18(void) {
  ...
  asm volatile("vsoxei64.v v12, (%0), v8" ::"r"(&BUFFER_O32[0]));
...
void TEST_CASE19(void) {
  ...
  VLOAD_64(v9,  0x9fe419208f2e05e0, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840,
        ...
        0x9031850931584902, 0x3189759837598759, 0x8319599991911111,
        0x8913984898951989);
  asm volatile("vsoxei64.v v9, (%0), v8" ::"r"(&BUFFER_O64[0]));
...
void TEST_CASE20(void) {
  ...
  VLOAD_64(v10, 0x9fe419208f2e05e0, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840,
        ...
        0x8913984898951989);
  VSET(2, e64, m1);
  asm volatile("vsoxei64.v v10, (%0), v8" ::"r"(&BUFFER_O64[0]));
...
int main(void) {
  ...
  printf("*****Running tests for vsoxei64.v*****\n");
