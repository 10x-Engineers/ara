...
void TEST_CASE1(void) {
  ...
  asm volatile("vluxei64.v v0, (%0), v8" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE2(void) {
  VSET(16, e64, m1);
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vluxei64.v v1, (%0), v8" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE3(void) {
  ...
  asm volatile("vluxei64.v v4, (%0), v2" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE4(void) {
  ...
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vluxei64.v v3, (%0), v8, v0.t" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE7(void) {
  ...
  asm volatile("vluxei64.v v4, (%0), v8, v0.t" ::"r"(&ALIGNED_I64[0]));
  VSET(16, e64, m1);
...
void TEST_CASE11(void) {
  ...
  asm volatile("vluxei64.v v5, (%0), v8" ::"r"(&ALIGNED_I8[0]));
...
void TEST_CASE12(void) {
  ...
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vluxei64.v v6, (%0), v8" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE15(void) {
  ...
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  write_csr(vstart, 2);
  asm volatile("vluxei64.v v7, (%0), v8" ::"r"(&ALIGNED_I64[0]));
  write_csr(vstart, 0);
...
void TEST_CASE16(void) {
  VSET(16, e8, m1);
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vluxei64.v v16, (%0), v8" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE17(void) {
  ...
  asm volatile("vluxei64.v v16, (%0), v8" ::"r"(&ALIGNED_I16[0]));
...
void TEST_CASE18(void) {
  ...
  asm volatile("vluxei64.v v16, (%0), v8" ::"r"(&ALIGNED_I32[0]));
...
void TEST_CASE19(void) {
  VSET(16, e64, m1);
  VLOAD_64(v8, 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120);
  asm volatile("vluxei64.v v9, (%0), v8" ::"r"(&ALIGNED_I64[0]));
...
void TEST_CASE20(void) {
  VSET(2, e64, m1);
  VLOAD_64(v8, 8, 120);
  asm volatile("vluxei64.v v10, (%0), v8" ::"r"(&ALIGNED_I64[0]));
...
int main(void) {
  ...
  printf("*****Running tests for vluxei64.v*****\n");
  TEST_CASE1();
  TEST_CASE2();
  TEST_CASE3();
  TEST_CASE4();
